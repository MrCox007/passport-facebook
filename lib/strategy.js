...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www.facebook.com/v2.8/dialog/oauth';
  options.tokenURL = options.tokenURL || 'https://graph.facebook.com/v2.8/oauth/access_token';
